...
class DcQ2View extends StatefulWidget {
  final DailyCheckFlowBloc bloc;
  final TextToSpeechBloc textToSpeechBloc;
  const DcQ2View({super.key,required this.bloc, required this.textToSpeechBloc});

  @override
  State<DcQ2View> createState() => _DcQ2ViewState();
}

class _DcQ2ViewState extends State<DcQ2View> with AutoSpeechMixin{
  ...
  void initState() {
    ...
    subscribeToSpeechStream(
      ...
      onSpeak: () => widget.textToSpeechBloc.textToSpeech(StringConstants.dcQ2HeadingText),
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Text(StringConstants.dcQ2HeadingText, style: h24),
        Gap(20),
          ...
          child: ListView.builder(
            ...
            itemBuilder:
              ...
              child: StreamBuilder<int>(
                  stream: widget.bloc.dcQ2SelectedIndex,
