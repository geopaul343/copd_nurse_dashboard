...
class QEightView extends StatefulWidget {
  final OnboardingBloc bloc;
  final TextToSpeechBloc textToSpeechBloc;
  const QEightView({super.key, required this.bloc, required this.textToSpeechBloc});

  @override
  State<QEightView> createState() => _QEightViewState();
}

class _QEightViewState extends State<QEightView> 
            ...
            itemBuilder:
                (context, index) => Padding(
                  ...
                  child: CustomeYesornoCard(
                    onclick: () {
                      setState(() {
                        widget.bloc.selectedRescuePackIndexQ8 = index;
                      });
                      widget.bloc.updateUi();
                    },
                    isSelected: widget.bloc.selectedRescuePackIndexQ8 == index,
