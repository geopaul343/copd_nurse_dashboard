...
class QTwelveView extends StatefulWidget {
  final OnboardingBloc bloc;
  final TextToSpeechBloc textToSpeechBloc;
  const QTwelveView({super.key, required this.bloc, required this.textToSpeechBloc});

  @override
  State<QTwelveView> createState() => _QTwelveViewState();
}

class _QTwelveViewState extends State<QTwelveView> 
with AutoSpeechMixin {
  ...
  void initState() {
    ...
    subscribeToSpeechStream(
      ...
      onSpeak:
          () => widget.textToSpeechBloc.textToSpeech(StringConstants.qFourViewSubHeadingText),
            ...
            children: [
              ...
              CupertinoPicker(
                ...
                onSelectedItemChanged: (int index) {
                  setState(() {
                    widget.bloc.selectedExperienceIndexQ12 = index;
                  });
                  widget.bloc.updateUi();
                },
                scrollController: FixedExtentScrollController(
                  initialItem: widget.bloc.selectedExperienceIndexQ12,
                ),
                children: List<Widget>.generate(20, (int experience) {
                  final isSelected =
                      experience == widget.bloc.selectedExperienceIndexQ12;
                  return Center(
                    child: Text(
