...
class QElevenView extends StatefulWidget {
  final OnboardingBloc bloc;
  final TextToSpeechBloc textToSpeechBloc;
  const QElevenView({super.key, required this.bloc, required this.textToSpeechBloc});

  @override
  State<QElevenView> createState() => _QElevenViewState();
}

class _QElevenViewState extends State<QElevenView> with AutoSpeechMixin {
  @override
  void initState() {
    super.initState();
    subscribeToSpeechStream(
      ...
      onSpeak:
          () => widget.textToSpeechBloc.textToSpeech(StringConstants.qElevenViewHeadingText),
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Text(StringConstants.qElevenViewHeadingText, style: h24),
        Gap(20),
            ...
            itemBuilder:
                (context, index) => Padding(
                  ...
                  child: CustomeYesornoCard(
                    onclick: () {
                      setState(() {
                        widget.bloc.selectedHospitalCareIndexQ11 = index;
                      });
                      widget.bloc.updateUi();
                    },
                    isSelected:
