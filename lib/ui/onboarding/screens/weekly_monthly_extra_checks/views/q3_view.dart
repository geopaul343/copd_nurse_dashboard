...
class WmcQ3View extends StatefulWidget {
  final WeeklyAndMonthlyCheckFlowBloc bloc;
  final TextToSpeechBloc textToSpeechBloc;
  const WmcQ3View({super.key,required this.bloc, required this.textToSpeechBloc});

  @override
  State<WmcQ3View> createState() => _WmcQ3ViewState();
}

class _WmcQ3ViewState extends State<WmcQ3View> with AutoSpeechMixin{
  ...
  void initState() {
    ...
    subscribeToSpeechStream(
      ...
      onSpeak: () => widget.textToSpeechBloc.textToSpeech(StringConstants.wmcQ3HeadingText),
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Text(StringConstants.wmcQ3HeadingText, style: h24),
        Gap(20),
          ...
          child: ListView.builder(
            ...
            itemBuilder:
              ...
              child: StreamBuilder<int>(
                  stream: widget.bloc.wmcQ3SelectedIndex,
