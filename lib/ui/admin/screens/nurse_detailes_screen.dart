...
import 'package:admin_dashboard/ui/widgets/custom_assigned_patients.dart';
...
import 'pateint_list_toadd_nurse_screen.dart'; 
...
class _NurseDetailesScreenState extends State<NurseDetailesScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBar(
        title: widget.nurse.userName ?? "Nurse Details",
        actions: [
          IconButton(
            icon: const Icon(
                        ...
                        return snapshot.data?.isEmpty == true
                            ...
                            : ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return AssignedPatients(patient: patient);
                              },
                            );
                      default:
